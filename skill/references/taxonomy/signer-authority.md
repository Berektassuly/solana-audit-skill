...
3. [Signer Authorization - official Solana Program Security lesson](https://solana.com/developers/courses/program-security/signer-auth) - demonstrates how a missing signer check can drain a vault path.
